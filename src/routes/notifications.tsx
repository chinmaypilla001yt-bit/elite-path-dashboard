    ...
    <AppShell>
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              disabled={unread === 0}
              className="inline-flex items-center gap-1.5 rounded-lg border border-foreground/10 bg-foreground/[0.03] px-3 py-1.5 text-xs text-foreground/80 hover:bg-foreground/[0.06] hover:text-foreground disabled:opacity-40"
            >
      ...
      {items.length === 0 ? (
        <GlassCard glow="blue" className="flex flex-col items-center justify-center p-16 text-center">
          ...
          <div className="mt-3 text-sm text-foreground/60">You're all caught up.</div>
        </GlassCard>
      ) : (
                ...
                >
                  ...
                  <div className="flex shrink-0 gap-1">
                    ...
                    <button
                      ...
                      title="Delete"
                      className="rounded-md p-1.5 text-foreground/50 hover:bg-red-500/20 hover:text-red-200"
                    >

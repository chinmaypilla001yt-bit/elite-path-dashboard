...
export function AscendSidebar() {
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-[260px] shrink-0 flex-col border-r border-foreground/5 bg-background/70 backdrop-blur-xl lg:flex">
        ...
        {nav.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.to as never}
              className={cn(
                "group relative flex items-center gap-3 rounded-lg px-3 py-2 text-sm text-foreground/70 transition-all",
            ...
            >
              ...
              {item.to === "/notifications" && unread > 0 && (
                <span className="ml-auto rounded-full bg-[image:var(--gradient-cyber)] px-1.5 py-0.5 text-[10px] font-semibold text-foreground shadow-[var(--shadow-glow)]">
                  {unread > 99 ? "99+" : unread}
                </span>
              )}
            </Link>
      ...
      <div className="mx-3 mb-4 rounded-xl border border-foreground/5 bg-foreground/[0.03] p-3">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="truncate font-mono text-[10px] uppercase tracking-widest text-foreground/50">
          ...
          <button
            ...
            title="Sign out"
            className="rounded-md p-1.5 text-foreground/50 transition hover:bg-foreground/[0.06] hover:text-foreground"
          >
